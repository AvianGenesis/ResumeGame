// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/TetrisInput.inputactions'
...
public class @TetrisInput : IInputActionCollection, IDisposable
{
    ...
    public struct InGameControlsActions
    {
        ...
        public void SetCallbacks(IInGameControlsActions instance)
        {
            if (m_Wrapper.m_InGameControlsActionsCallbackInterface != null)
            {
                ...
                @ToggleControl.started -= m_Wrapper.m_InGameControlsActionsCallbackInterface.OnToggleControl;
                @ToggleControl.performed -= m_Wrapper.m_InGameControlsActionsCallbackInterface.OnToggleControl;
                @ToggleControl.canceled -= m_Wrapper.m_InGameControlsActionsCallbackInterface.OnToggleControl;
            }
